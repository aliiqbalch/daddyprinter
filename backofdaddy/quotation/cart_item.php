...
class Cart_Item{
    ...
    public function __construct($itemID,$qty=0,$unitPrice=0,$title="abc",$productID=0,$catID=0,$basePrice=0,$costPrice=0,$wholesalePrice=0,$itemsValue = array(), $total=0,$length=0,$width =0,$rate=0) {
    ...
    public function __set($name, $value) {
        ...
        $allowed_fields = array("itemID","productID","title","catID","qty","basePrice","wholesalePrice","itemsValue","length","width","rate","total","unitPrice");
