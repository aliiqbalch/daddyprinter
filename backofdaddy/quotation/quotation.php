                        ...
                        <table class="table table-bordered table-striped tbl-respon2s">
                            ...
                            foreach($objItems->items as $item){
                                ...
                                <tr class="colorwhite">
									...
									<td class="colorwhite text-bold"><?=$item->title?></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive tbl-respon">
                                    ...
                                    <tr>
                                        <td class="colorgry" id="colorgry1" colspan="5"></td>
                                        <td class="colorwhite"><?=$objItems->total?><input type="hidden" name="grand_total" id="grand_total"  value="<?=$objItems->total?>" /></td>
                                    </tr>
                                    <tr>
