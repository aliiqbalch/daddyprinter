...
//									die("SSs");
								...
								<td>
									<input type="text" name="discount" class="input-sm" style="width: 50px" value="<?=getDiscount($dbConn,$orderId)?>">
									<input type="hidden" name="disId" class="input-sm" style="width: 50px" placeholder="discount" value="<?=getDiscountId($dbConn,$orderId)?>">
								</td>
								<td>
