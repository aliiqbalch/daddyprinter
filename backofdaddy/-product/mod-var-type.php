...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processpro.php?action=modvartype"  enctype="multipart/form-data" onsubmit="return validate(this)">
									...
									<div class="col-md-6">
										<div class="panel panel-danger">
											<div class="panel-heading">
												<div class="checkbox">
													<label><input type="checkbox" name="vtype_id[]" value="<?php echo $var_type_id; ?>" <?php chekaddvariationtype($dbConn, $PI, $var_type_id);?> ><?php echo $var_type_title;?></label>
												</div>
											</div>
										</div> 
									</div>
