						...
						<div class="row">
							...
							<div id="promotional" style="display:none;" >
								...
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									...
									<input type="text" name="txtCostPrice" class="formField" value="0"/>
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Wholesale price:</label></br>
									<input type="text" name="txtWholePrice" class="formField" value="0" />
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Retail price:</label></br>
									<input type="text" name="txtRetailPrice" class="formField" value="0" />
								</div>
							</div>
