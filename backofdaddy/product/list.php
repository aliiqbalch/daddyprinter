		...
		<div class="container-fluid container_block">
			...
			<div class="row bord-right-space" id="loadProducts" >
				<div class="table-responsive tbl-respon">
					<table id="shocategory" class="table table-bordered table-striped tbl-respon2">
						<thead>
							<tr>
								<th >Sr.No</th>
								<th >Category</th>
									...
									<tr>
										...
										<td>
											<?php if(modPerView($dbConn,"7")){
												?>
												<a href="javascript:viewpro(<?=$pro_id;?>)">
													<i class="fa fa-eye"></i>&nbsp;
												</a>
										<?php
											} if(modPerModify($dbConn,"7")){
												?>
												<a href="javascript:modifyPro(<?=$pro_id;?>)">
													<i class="fa fa-edit"></i>&nbsp;
												</a>
										<?php
											} if(modPerDelete($dbConn,"7")){
												?>
												<a href="javascript:deletePro(<?=$pro_id;?>)">
