...
?> 
	...
	<section class="content" >
			...
			<div class="container-fluid container_block">
						...
						<div class="row">
							...
							if($cat_id == 4){ ?>
								...
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									...
									<input type="text" name="txtQty" class="formField" value="<?php echo $pro_s_qty;?>" readonly />
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Quantity Reminder:</label></br>
									<input type="text" name="txtQtyRem" class="formField" value="<?php echo $pro_s_qty_rim;?>" readonly />
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Cost price:</label></br>
									<input type="text" name="txtCostPrice" class="formField" value="<?php echo $pro_s_cost_price;?>" readonly/>
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Wholesale price:</label></br>
									<input type="text" name="txtWholePrice" class="formField" value="<?php echo $pro_s_whole_price;?>" readonly/>
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Retail price:</label></br>
									<input type="text" name="txtRetailPrice" class="formField" value="<?php echo $pro_s_retail_price;?>" readonly/>
								</div>
								<?php
							}
							?>
								...
								if($cat_id == 1){
									...
									<div id="offset">
										...
										<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
											...
											<input type="text" name="txtMachine" class="formField" value="<?=$pro_machine?>" readonly />
										</div>
										<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
											<label>Printing Size</label></br>
											<input type="text" name="txtPrintingSize" class="formField" value="<?=$pro_printing_size?>" readonly />
										</div>
									</div>
							<?php
								}
							if($cat_id == 3){
								...
								<div id="outdoor">
									...
									<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
										<label>Cost price:</label></br>
										<input type="text" name="txtCostPrice" class="formField" value="<?=$pro_s_cost_price?>" readonly />
									</div>
									<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
										<label>Wholesale price:</label></br>
										<input type="text" name="txtWholePrice" class="formField" value="<?=$pro_s_whole_price?>" readonly />
									</div>
									<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
										<label>Retail price:</label></br>
										<input type="text" name="txtRetailPrice" class="formField" value="<?=$pro_s_retail_price?>" readonly />
									</div>
								</div>
								<?php
							}
				...
				<?php if(modPerVariation($dbConn,"7")){ ?>
				<div class="row inner_heading">
