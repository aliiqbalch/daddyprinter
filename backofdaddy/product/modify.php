						...
						<div class="row">
							...
							<div id="offset" style="<?php if($cat_id == 1){ }else{echo "display:none;";}?>" >
								...
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									...
									<input type="text" name="txtMachine" class="formField" value="<?=$pro_machine?>" />
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Printing Size</label></br>
									<input type="text" name="txtPrintingSize" class="formField" value="<?=$pro_printing_size?>" />
								</div>
							</div>
							<div id="outdoor" style="<?php if($cat_id == 3){echo "display:inline"; }else{echo "display:none;";}?>" >
								...
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									...
									<input type="text" name="txtCostPriceOutDoor" id="txtCostPrice" class="formField" value="<?=$pro_s_cost_price?>" />
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Wholesale price:</label></br>
									<input type="text" name="txtWholePriceOutDoor" class="formField" value="<?=$pro_s_whole_price?>"/>
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Retail price:</label></br>
									<input type="text" name="txtRetailPriceOutDoor" class="formField" value="<?=$pro_s_retail_price?>" />
								</div>
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Design:</label></br>
									<input type="text" name="txtDesignOutdoor" class="formField" value="<?=$design_cost?>"  />
								</div>
							</div>
							<div id="promotional" style="display:<?php if($cat_id == 4){echo "inline";}else{echo "none";}?>;" >
								...
								<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
									<label>Design:</label></br>
									<input type="text" name="txtDesignPromotional" class="formField" value="<?=$design_cost?>"  />
								</div>
